...
const initialButtons = [
    { id: 1, title: "Datos del ID", subtitle: "Registra los datos correspondientes del ID.", ready: false },
    { id: 2, title: "Fotografías de Acceso", subtitle: "Carga fotografías del acceso.", ready: false },
    { id: 3, title: "Fotografías del ID", subtitle: "Carga fotografías del ID.", ready: false },
    { id: 4, title: "Fotografías Empalme / TG", subtitle: "Carga fotografías del empalme / TG.", ready: false },
    { id: 5, title: "Fotografías TDA y F", subtitle: "Mediciones de voltage entre lineas / antes.", ready: false },
    { id: 6, title: "Fotografías TDA y F", subtitle: "Mediciones de voltages de fase / antes.", ready: false },
    { id: 7, title: "Fotografías TDA y F", subtitle: "Mediciones de corrientes / antes.", ready: false },
    { id: 8, title: "Planta a intervenir", subtitle: "Carga fotografías de la planta.", ready: false },
    { id: 9, title: "Registro de trabajos", subtitle: "Carga fotografías de Readecuación de PCC.", ready: false },
    { id: 10, title: "Registro de terminaciones", subtitle: "Carga fotografías de Canalización, ruteo, etc.", ready: false },
    { id: 11, title: "Fotografías TDA y F", subtitle: "Mediciones de voltages entre lineas / después.", ready: false },
    { id: 12, title: "Fotografías TDA y F", subtitle: "Mediciones de voltages de fase / después.", ready: false },
    { id: 13, title: "Fotografías TDA y F", subtitle: "Mediciones de corrientes / después.", ready: false },
    { id: 14, title: "Planta intervenida", subtitle: "Carga fotografías de la planta.", ready: false },
];
    ...
    const handleToggleReady = (id) => {
        setButtons(prevButtons =>
            prevButtons.map(button =>
                button.id === id ? { ...button, ready: !button.ready } : button
            )
        );
    };
